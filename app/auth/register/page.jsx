        ...
        <div className="w-full lg:w-1/2 flex justify-center items-center p-4 lg:p-8">
          <div className="w-full max-w-md bg-white rounded-xl shadow-xl p-8">
            ...
            {regUser?.data?.message && (
              <div className="bg-blue-50 text-blue-700 p-3 rounded-lg flex items-center mb-6">
                <CheckCircle className="h-5 w-5 mr-2" />
                <p>{regUser.data.message}</p>
              </div>
            )}
            {message && (
            ...
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              //   <span className="px-3 bg-white relative text-gray-500 text-sm">
              //     or continue with
              //   </span>
              // </div>
